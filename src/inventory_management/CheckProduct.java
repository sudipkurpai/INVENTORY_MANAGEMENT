 ...
 */
public class CheckProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cus.prod.Bye det");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 0, -1, -1));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventory_management/button (13).png"))); // NOI18N
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 500, -1, -1));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventory_management/button (15).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckProduct().setVisible(true);
            }
        });
    }
